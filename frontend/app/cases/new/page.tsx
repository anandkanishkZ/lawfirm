...
import { createCase, CreateCaseData } from '@/lib/api/cases';
...
export default function NewCasePage() {
  ...
  const [formData, setFormData] = useState<CreateCaseData>({
    ...
    assignedLawyerId: '',
    court: '',
    filingDate: new Date().toISOString().split('T')[0] as string,
    nextHearing: '' as string,
    description: '',
    plaintiff: [],
    defendant: [],
    priority: 'MEDIUM',
  ...
  const handleChange = (field: keyof CreateCaseData, value: any) => {
