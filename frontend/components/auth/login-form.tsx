...
import { Scale, Eye, EyeOff, Moon, Sun, Monitor, AlertCircle, Info } from 'lucide-react';
...
export function LoginForm() {
  ...
  // Check for session messages (token expiration, logout, etc.)
  useEffect(() => {
    ...
    <div className="w-full max-w-md animate-fade-in">
      ...
      <Card className="shadow-strong animate-slide-up">
        ...
        <CardContent className="space-y-6">
          {/* Session/Token Expiration Message */}
          {sessionMessage && (
            <Alert className="border-amber-500/50 bg-amber-50 dark:bg-amber-950/20 animate-scale-in">
